# Vendored from yakhyo/crack-segmentation (MIT) — the released checkpoints pickle
# UNet/Conv/DoubleConv instances from the package `crackseg.models.unet`, so this
# module must stay importable at exactly that path for torch.load to unpickle.
import torch
